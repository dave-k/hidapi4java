...
public interface Kernel32 extends W32API {
    ...
    int FormatMessage(int dwFlags, Pointer lpSource, int dwMessageId,
                      int dwLanguageId, PointerByReference lpBufferPointerBy,
    ...
    Pointer CreateEventA(SECURITY_ATTRIBUTES lpSecurityAttributes,
...
//                    Memory lpBuffer,
     ...
     * Marks pending synchronous I/O operations that are
     * issued by the specified thread as canceled.
     */
    boolean CancelSynchronousIo(HANDLE hThread);

    /*
     * WaitForSingleObject
     * return values
     */
    public static int WAIT_OBJECT_0 = 0x00000000;
    public static int WAIT_TIMEOUT = 0x00000102;
}
